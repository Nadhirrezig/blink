...
//   {
//     id: 2,
//     name: 'Restaurant Médina',
//     position: { lat: 34.7390, lng: 10.7600 },
//     address: '45 Rue de la Médina, Sfax',
...
//     id: 3,
//     name: 'Bistro du Lac',
//     position: { lat: 36.8441, lng: 10.2560 },
//     address: '78 Boulevard du Lac, Tunis',
...
//               }}
//             >
//               {/* Map markers will be added here when Google Maps loads */}
//             </GoogleMap>
//           </div>
//         ) : (
              ...
              {selectedStore && (
                ...
                >
                  <div className="p-2 max-w-xs">
                    ...
                    <Button className="w-full mt-2 text-sm transition-all duration-200 hover:bg-primary/90" size="sm">
                      View Menu
                    </Button>
                  </div>
                </InfoWindow>
